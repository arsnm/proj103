...
class GroupServerManager:
    ...
    def start_movement(self):
        if self.ongoing_movement:
            print("ERROR - A movement is already ongoing.")
        else:
            with self.movement_lock:
                self.ongoing_movement = True

    def _ongoing_movement(self):
        with self.movement_lock:
            return self.ongoing_movement
    ...
    def _send_check(self):
        ...
        while retry_count < self.max_retries and not self._ongoing_movement():
            try:
